...
<html>
	...
	<nav class="gtco-nav" role="navigation">
       ...
       <header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(MainWeb/images/img_5)">
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12 col-md-offset-0 text-left">
							...
							<p><br><br><br><br></p>
							<span class="intro-text-small">I-CAR</span>
		...
		<div class="gtco-container">
			<div class="row">
				<div>
					...
					ArrayList<Product> productlist = productdao.getOrdeList((String)session.getAttribute("username"));
					User user = userdao.getUserInformation((String)session.getAttribute("username"));
					Product product = new Product();      
					%> 
					<h1>User Details</h1>
					<p>User Name:<%=user.getUsername()%></p>
					<p>User E-Mail:<%=user.getEmail() %></p>
					<p>User Address:<%=user.getAddress() %></p>     
				
					
					<p><br><br></p>
					
					<h1>OrderList</h1>
				   <table name="orderlist" border="1">
					  <tr>
					    <th>Product ID</th>
					    <th>Product Name</th>
