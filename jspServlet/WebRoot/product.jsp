...
<html>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(MainWeb/images/5.jpg)">
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						...
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">As a result of our high quality products and outstanding customer service, we have gained a global sales network reaching USA, UK, and Germany.
</span>
				...
				<div class="row">
			<% 
			   ProductDAOImpl itemsDao = new ProductDAOImpl(); 
               ArrayList<Product> list = itemsDao.getAllProduct();
	         ...
	         %>   
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images_b/<%=item.getPicture()%>.jpg"  class="fh5co-project-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<br>
							<img src="images_b/<%=item.getPicture() %>.jpg" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
						    ...
						    <div class="fh5co-text">					
                            <a href="prodetails.jsp?id=<%=item.getId()%>">More Details...</a>
                            <hr>
						</div>
					</a>
				</div>
