...
<html>
	...
	<header id="gtco-header" class="gtco-cover" role="banner" style="background-image: url(MainWeb/images/img_6.jpg)">
			...
			<div class="row">
				<div class="col-md-12 col-md-offset-0 text-left">	
						...
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							...
							<p><br><br><front style="color:white">We will contact you as soon as possible.</front></p>
							<p><a href="index.jsp">Click back to HOME</a>
						</div>
