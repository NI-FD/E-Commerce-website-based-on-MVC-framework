...
<html>
	...
	<nav class="gtco-nav" role="navigation">
	  ...
	  <header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(MainWeb/images/2.jpg)">
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-15em">
						...
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">We believe in Technology Change the World.
</span>
